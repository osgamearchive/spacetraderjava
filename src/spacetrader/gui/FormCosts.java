...
public class FormCosts extends WinformForm {
  ...
  private void InitializeComponent() {
    ...
    this.lblMerc.setSize(new Size(39, 13));
    ...
    this.lblIns.setSize(new Size(39, 13));
    ...
    this.lblInt.setSize(new Size(39, 13));
    ...
    this.lblTax.setSize(new Size(39, 13));
    ...
    this.lblTotal.setSize(new Size(39, 13));
    ...
    this.lblTotalLabel.setSize(new Size(34, 13));
    ...
    this.lblTaxLabel.setSize(new Size(84, 13));
    ...
    this.lblIntLabel.setSize(new Size(47, 13));
    ...
    this.lblMercLabel.setSize(new Size(72, 13));
    ...
    this.lblInsLabel.setSize(new Size(59, 13));

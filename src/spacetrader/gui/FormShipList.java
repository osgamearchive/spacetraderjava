...
public class FormShipList extends SpaceTraderForm
{
	...
	public FormShipList()
	{
		...
		lblPrice = new Label[] { lblPrice0, lblPrice1, lblPrice2, lblPrice3, lblPrice4, lblPrice5, lblPrice6,
				lblPrice7, lblPrice8, lblPrice9, };

		btnBuy = new Button[] { btnBuy0, btnBuy1, btnBuy2, btnBuy3, btnBuy4, btnBuy5, btnBuy6, btnBuy7, btnBuy8,
				btnBuy9, };
		//#endregion
	...
	private void InitializeComponent()
	{
		...
		// boxShipInfo
		//
		boxShipInfo.Controls.addAll((new WinformControl[] { lblCrew, lblGadget, lblShield, lblWeapon, lblHull,
				lblRange, lblBays, lblSize, lblName, picShip, lblGadgetLabel, lblCrewLabel, lblShieldLabel,
				lblWeaponLabel, lblHullLabel, lblRangeLabel, lblBaysLabel, lblNameLabel, lblSizeLabel }));
		...
		Controls.addAll(Arrays.asList(boxShipInfo, lblPrice9, btnInfo9, lblName9, btnBuy9, lblPrice8, btnInfo8,
				lblName8, btnBuy8, lblPrice7, btnInfo7, lblName7, btnBuy7, lblPrice6, btnInfo6, lblName6, btnBuy6,
				lblPrice5, btnInfo5, lblName5, btnBuy5, lblPrice4, btnInfo4, lblName4, btnBuy4, lblPrice3, btnInfo3,
				lblName3, btnBuy3, lblPrice2, btnInfo2, lblName2, btnBuy2, lblPrice1, btnInfo1, lblName1, btnBuy1,
				lblPrice0, btnInfo0, lblName0, btnBuy0, btnClose));
	...
	private void UpdateAll()
	{
		for (int i = 0; i < lblPrice.length; i++)
		{
			...
			if (Consts.ShipSpecs[i].MinimumTechLevel().CastToInt() > game.Commander().getCurrentSystem().TechLevel()
					.CastToInt())
	...
	private void btnBuyInfo_Click(Object sender)
	{

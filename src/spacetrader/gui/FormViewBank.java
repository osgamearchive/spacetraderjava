...
public class FormViewBank extends SpaceTraderForm
{
	...
	private void InitializeComponent()
	{
		...
		Controls.addAll(Arrays.asList(lblMaxNoClaim, btnClose, btnPayBack, lblInsAmt, lblInsAmtLabel, lblNoClaimLabel,
				lblShipValueLabel, lblInsurance, lblMaxLoanLabel, lblCurrentDebtLabel, lblLoan, btnBuyInsurance,
				lblNoClaim, lblShipValue, btnGetLoan, lblMaxLoan, lblCurrentDebt));

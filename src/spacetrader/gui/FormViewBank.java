...
public class FormViewBank extends WinformForm {
  ...
  private void InitializeComponent() {
    ...
    this.lblLoan.setSize(new Size(44, 19));
    ...
    this.lblCurrentDebtLabel.setSize(new Size(75, 13));
    ...
    this.lblMaxLoanLabel.setSize(new Size(88, 13));
    ...
    this.lblCurrentDebt.setSize(new Size(56, 13));
    ...
    this.lblMaxLoan.setSize(new Size(56, 13));
    ...
    this.btnGetLoan.setSize(new Size(61, 22));
    ...
    this.btnBuyInsurance.setSize(new Size(90, 22));
    ...
    this.lblNoClaim.setSize(new Size(32, 13));
    ...
    this.lblShipValue.setSize(new Size(56, 13));
    ...
    this.lblNoClaimLabel.setSize(new Size(106, 13));
    ...
    this.lblShipValueLabel.setSize(new Size(65, 13));
    ...
    this.lblInsurance.setSize(new Size(81, 19));
    ...
    this.lblInsAmt.setSize(new Size(82, 13));
    ...
    this.lblInsAmtLabel.setSize(new Size(38, 13));
    ...
    this.btnPayBack.setSize(new Size(90, 22));
    ...
    this.lblMaxNoClaim.setSize(new Size(33, 13));
